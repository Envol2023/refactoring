...
TODO trouver une phrase d'accroche
...
** Principes reconnus comme universel _(Code Clean)_
...
TODO Inclure document sonarqube
...
** => jusqu'à la lecture du livre de M. Folwer
