...
* Conservation _qualités externes_ observables
...
** Disponibles dans _presque_ tous les https://en.wikipedia.org/wiki/List_of_tools_for_static_code_analysis[langages]
