...
Dans la philosophe des tests, l'échec n'est pas négatif, c'est sa persistence qui l'est éventuellement.
...
*** => Beaucoup de préoccupations différentes 
...
** Liés au temps, gestion asynchrone, randomisation
...
** Comment _disposer_ de la dépendance pour les tests
* Solution
...
** S'assurer qu'une seule instance puisse exister.
* Anti-pattern 
** Difficile à adapter aux différentes situations
** Très fort couplage à une classe
** Un changement impacte tout le système
*** => Aucune isolation :(
...
** Chercher les noms de propriétés, de fonctions qui sont proches
--
...
Les responsabilités apparaissent en essayant de la tester
...
*Etape {counter:Mikado_Sample}*: C'est parti
