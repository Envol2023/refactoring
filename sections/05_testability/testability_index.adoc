...
Contenu de _test_prettyworld.test_approval.approved.txt_

[source,text]
----
{'Sample City': [Person(name='Alice', age=25, address=Address(street='123 Street A', 
 city=City(name='Sample City')), 
...
@@ -1 +1 @@
-{'Sample City': [Person(name='AliceFOO', age=25, address=Address(street='123 Street A', city=City(name='Sample City')), knows=[Person(name='Charlie', age=28, address=Address(street='789 Street C', city=City(name='Sample City')), knows=[])])]}
+{'Sample City': [Person(name='Alice', age=25, address=Address(street='123 Street A', city=City(name='Sample City')), knows=[Person(name='Charlie', age=28, address=Address(street='789 Street C', city=City(name='Sample City')), knows=[])])]}
...
TODO Faire topo sur effet Harray Potter du mocking
TODO Donner URL sur /pytest-euclid
...
TODO Simulation base de données avec repository

== Boucles imbriquées 

TODO Boucles imbriquées 

== Recherche de responsabilité sur legacy 

TODO  Recherche de responsabilité sur legacy 
