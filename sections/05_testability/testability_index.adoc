...
La testabilité est la facilité à créer un test unitaire
Un test unitaire doit permettre d'isoler le composant et ne tester que lui, si possible.
Or cette faculté est très influencer par la conception.

Si un code est difficile à tester ne le sera, ou cela représentera une grande charge qui découragera.
