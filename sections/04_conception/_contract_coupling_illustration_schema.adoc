= Ne tenir compte que du contrat
...
de ce qu'[.big]#*EST*# sa dépendance, {cr}
mais {cr}
de ce qu'[.big]#*OFFRE*# sa dépendance.
--
...
ifndef::mode_slide[:leveloffset: -1]
//-+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+
