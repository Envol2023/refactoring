...
** Décomposition en modules => réduction de la complexité
* Module
** Entité du langage 
...
[%step] 
Comment _sentir_ cette minimisation ? 
...
** Un utilisateur n'a pas besoin/envie de tous connaître
* *Interface Segregation Principle*
** => Offrir plusieurs facettes
** => Laisser l'utilisateur choisir celle qui lui importe
