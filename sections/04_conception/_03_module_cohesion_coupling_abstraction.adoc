...
** du travail -> en tâches par domaine d'expertise
--
[.right-column-1-3]
--
...
*** => *Forte Cohésion*
** Ne devrait pas en savoir plus que nécessaire sur les autres domaines 
*** => *Faible Couplage*
...
** Espace de nommage => packaging, modules python 
