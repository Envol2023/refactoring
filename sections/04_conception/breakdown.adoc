...
[NOTE.notes]
La première étape consiste à repérer des "clusters", des regroupements d'éléments particulièrement reliés.

[.center]
Recherche de regroupements d'éléments (_clusters_)
