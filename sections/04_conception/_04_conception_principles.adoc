...
* Synthèse logique
** Single Responsibility Principal => Chacun son job
** Composition => Assembler les bons composants
** Abstraction => ne dépendre que du contrat
* Qui des deux doit s'adapter à l'autre ?
** Le composant de haut-niveau ou celui de bas-niveau ?

== Dependency Inversion Principal > Niveaux
...
== Dependency Inversion Principal > Approche classique 
...
== Dependency Inversion Principal > Abstraction par le bas 
...
== Dependency Inversion Principal > Abstraction par le haut 
...
== Dependency Inversion Principal > Adapter 
...
**Compétence principale / Pratique quotidienne > Expertise**
