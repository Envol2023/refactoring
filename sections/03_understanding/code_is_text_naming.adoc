...
[source,python]
----
complaint = complaintService.getNext();
...
countries_to_actors.put("fr", find_actors_in_country("fr"))
----
...
Indiquer dans le nom de la méthode les éléments qui aideront à la comprendre
rien qu'à la lecture du nom.
...
=== Nommage: Utilisez des antonymes pour clôturer
...
[.ppt]
* Même si à destination des humains seulement
...
include::code_is_text_naming_exemple_collect_stars.adoc[]
