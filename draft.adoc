...
**Reprendre les slides du cours java cours_framework_2019\cours\good_practices\principes_reduce_nb_of_elements.adoc**
...
Uen fonction qui fait des choses qui relèvent, au même niveau d'abstraction, de plusieurs domaines, contrevient au princip
